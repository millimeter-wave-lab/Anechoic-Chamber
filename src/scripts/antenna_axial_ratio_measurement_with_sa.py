...
if __name__ == '__main__':
    ...
    parser.add_argument('-minf_mhz','--minimum_freq_mhz', type = float, default = sweep[0], help = 'minimum frequency span in mhz')
    parser.add_argument('-maxf_mhz','--maximum_freq_mhz', type = float, default = sweep[1], help = 'maximum frequency span in mhz')
    ...
    try:
        MIN_FREQ_default = args.minimum_freq_mhz * 1e6
    except:
