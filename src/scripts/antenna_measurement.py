...
if __name__ == '__main__':
    ...
    try :
        ...
        file = open(name,'wb')
        config_dict = {'STEPS_PER LOOP': STEPS_PER_LOOP,
    ...
    if (siglent_use):
        ...
        # visaname = 'TCPIP0::192.168.100.35::inst0::INSTR'
    ...
    print("YOU HAVE 15 SECONDS TO LEAVE THE ROOM!")
    #time.sleep(16)
